...
3、package目录：组件的配置目录
 ...
 ## amlogic buildroot 添加package软件包（本地源码）
...
### 编写hello world源码(仅本地源码package需要)
...
## amlogic buildroot添加package软件包（网络下载资源码）
...
## Amlogic buildroot下如何配置项目defconfig
